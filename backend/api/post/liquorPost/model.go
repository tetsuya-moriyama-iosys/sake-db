...
type RequestData struct {
	...
	Youtube           string  `form:"youtube" validate:"omitempty,youtube"`
	VersionNo         *int    `form:"version_no" validate:"omitempty,gte=1"`
	SelectedVersionNo *int    `form:"selected_version_no" validate:"omitempty,gte=1"`
}
